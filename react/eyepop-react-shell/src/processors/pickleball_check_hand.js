...
class PickleballCheckHandProcessor extends Processor {
    buffer = [];
    ...
    async setCanvasContext(canvasContext, stream) {
        const pop_uuid = process.env.NEXT_PUBLIC_PERSON_POSE3D_POP_UUID;
        const api_key = process.env.NEXT_PUBLIC_PERSON_POSE3D_POP_API_KEY;
        ...
        this.endpoint.changePop(ComposablePops.Person3DHands);
...
export default PickleballCheckHandProcessor;